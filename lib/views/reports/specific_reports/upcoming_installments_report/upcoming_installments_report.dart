...
class UpcomingInstallmentsReportPage extends StatelessWidget {
  final List<UpcomingInstallmentsReportModel> reports;
  final int daysAhead;

  const UpcomingInstallmentsReportPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Upcoming Installments ($daysAhead days)'),
        actions: [
          IconButton(
      ...
      body: Center(
        child: TRoundedContainer(
          ...
          child: reports.isEmpty
              ? const Center(child: Text('No upcoming installments found'))
              : PdfPreview(
            ...
            children: [
              pw.Row(
                ...
                children: [
                  ...
                  pw.Text('Upcoming Installments Report ($daysAhead days)',
                      style: pw.TextStyle(
                  ...
                  for (var report in reports)
                    pw.TableRow(
                      children: [
                        ...
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(6),
                          child: pw.Text(report.daysUntilDue.toString(),
                              style: const pw.TextStyle(fontSize: 8)),
                        ),
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(6),
              ...
              // Summary
              pw.Text(
                'Total Amount Due: ${reports.fold(0.0, (sum, report) => sum + double.parse(report.amountDue)).toStringAsFixed(2)}',
                style:
