...
class InstallmentReportPage extends StatelessWidget {
  ...
  static Future<Uint8List> generatePdfInBackground(Map<String, dynamic> params) async {
    final List<InstallmentTableModel> installmentPlans = params['installmentPlans'];
    ...
    const rowsPerPage = 15; // Reduced rows per page for better fit
        ...
        pw.MultiPage(
          ...
          build: (context) => [
            pw.Row(
              ...
              children: [
                pw.Text(companyName, style: pw.TextStyle(fontSize: 16, fontWeight: pw.FontWeight.bold)), // Reduced font size
              ],
            ),
            pw.SizedBox(height: 8),
            pw.Text('Branch: $branchName', style: const pw.TextStyle(fontSize: 12)), // Reduced font size
            pw.Text('Cashier: $cashierName', style: const pw.TextStyle(fontSize: 12)), // Reduced font size
            pw.Divider(),
            pw.SizedBox(height: 8),
            ...
            pw.Table(
              ...
              columnWidths: {
                0: const pw.FlexColumnWidth(1.5), // Sequence No
                1: const pw.FlexColumnWidth(2.5), // Description
                2: const pw.FlexColumnWidth(2.5), // Due Date
                3: const pw.FlexColumnWidth(2.5), // Paid Date
                4: const pw.FlexColumnWidth(1.5), // Amount Due
                5: const pw.FlexColumnWidth(1.5), // Paid Amount
                6: const pw.FlexColumnWidth(2.5), // Remarks
            ...
            pw.Align(
              ...
              child: pw.Column(
                children: [
                  pw.Text(softwareCompanyName, style: pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold)), // Reduced font size
                  pw.SizedBox(height: 8),
                  pw.Row(
                    mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                    children: [
                      pw.Text("Generated by: $softwareCompanyName", style: const pw.TextStyle(fontSize: 8)), // Reduced font size
                      pw.BarcodeWidget(
  ...
  static pw.Widget _tableHeader(String text) {
    return pw.Padding(
      ...
      child: pw.Text(text, style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 10)), // Reduced font size
    );
  }
  ...
  static pw.Widget _tableCell(String text) {
    return pw.Padding(
      padding: const pw.EdgeInsets.all(4),
      child: pw.Text(text, style: const pw.TextStyle(fontSize: 10)), // Reduced font size
    );
  }
}