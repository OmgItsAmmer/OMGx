...
class ProductSearchBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // NOTE: `allProducts` is an RxList. We must "read" it inside a reactive builder
    // (e.g., `.toList()` / `.length`) so GetX can track dependencies correctly.
    // This also prevents "improper use of GetX" errors if a parent wraps this widget in Obx.
    return Obx(() {
      final options = productController.allProducts.toList(growable: false);
