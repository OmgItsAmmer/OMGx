...
class OrderInfo extends StatelessWidget {
  ...
  Widget _buildStatusDropdown(
    ...
    return SizedBox(
      width: dropdownWidth,
      child: Obx(() {
        // Show shimmer effect when status is being updated
        if (orderController.isStatusLoading.value) {
        ...
        return TRoundedContainer(
          ...
          child: DropdownButtonHideUnderline(
            child: DropdownButton<OrderStatus>(
              ...
              onChanged: orderController.isStatusLoading.value
                  ? null
                  : (OrderStatus? newValue) async {
                      if (newValue != null) {
                        try {
