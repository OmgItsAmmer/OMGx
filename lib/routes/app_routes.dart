...
class TAppRoutes {
  static final List<GetPage> pages = [
    ...
    GetPage(
        ...
        middlewares: [TRouteMiddleware()]),
    GetPage(
        name: TRoutes.addCustomer,
        page: () => const AddCustomerScreen(),
        middlewares: [TRouteMiddleware()]),
    //Salesman Screens
    GetPage(
        name: TRoutes.salesman,
        page: () => const SalesmanScreen(),
        middlewares: [TRouteMiddleware()]),
    GetPage(
        name: TRoutes.salesmanDetails,
        page: () => const SalesmanDetailScreen(),
        middlewares: [TRouteMiddleware()]),
    GetPage(
        name: TRoutes.addSalesman,
        page: () => const AddSalesmanScreen(),
        middlewares: [TRouteMiddleware()]),

    //installment Screens
    GetPage(
        name: TRoutes.installment,
    ...
    //Store
    GetPage(
        name: TRoutes.storeScreen,
        page: () => const StoreScreen(),
        middlewares: [TRouteMiddleware()]),

    //Media Screens
    GetPage(
        name: TRoutes.mediaScreen,
        page: () => const MediaScreen(),
        middlewares: [TRouteMiddleware()]),

    //Report Screens
    GetPage(
        name: TRoutes.reportScreen,
