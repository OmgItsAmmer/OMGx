class ShopModel {
  ...
  factory ShopModel.fromJson(Map<String, dynamic> json) {
    return ShopModel(
      ...
      thresholdFreeShipping: json['threshold_free_shipping'] as double?,
      profile1: json['profile1'] as double?,
      profile2: json['profile2'] as double?,
      profile3: json['profile3'] as double?,
    );
  }
